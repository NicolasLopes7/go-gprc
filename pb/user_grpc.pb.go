...
func (x *userServiceAddUsersStreamBothClient) Send(m *Users) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceAddUsersStreamBothClient) Recv() (*Users, error) {
	m := new(Users)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *userServiceAddUsersStreamBothServer) Send(m *Users) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceAddUsersStreamBothServer) Recv() (*Users, error) {
	m := new(Users)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
